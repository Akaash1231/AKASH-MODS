...
btn.onclick=function(){
  ...
  if(h.includes('tarviral.com')||h.includes('rodaemotor.com')){
    runFullBypass();
  }else if(h.includes('aincradproxy.xyz')){
    ov.remove();
    fetch('https://aincradproxy.xyz/getkey.data',{method:'POST',credentials:'include',headers:{'content-type':'application/x-www-form-urlencoded;charset=UTF-8','accept':'*/*','origin':'https://aincradproxy.xyz','referer':'https://aincradproxy.xyz/getkey','x-requested-with':'mark.via.gp'}})
