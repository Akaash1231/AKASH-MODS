...
btn.onclick=function(){
  ...
  if(val!=='AKASH BHAI THANKS'){err.textContent='\u274c Wrong key! Access denied.';inp.value='';return;}
  err.textContent='';
